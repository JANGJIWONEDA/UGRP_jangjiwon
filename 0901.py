...
class CustomDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        img = item['image']  # 이미 PIL.Image 객체임
        label = item['label']
        if self.transform:
...
test_dataset = load_dataset("xodhks/Children_Sketch", split="test")
